...
Wersja 0.16.0 zamraża zakres funkcji przed publiczną weryfikacją Google OAuth i
...
- instalator `PT-Calendar-Manager-0.16.0-Setup.exe`;
- wersję przenośną `pt-calendar-manager-0.16.0-portable.zip`;
- odpowiadający kod źródłowy `pt-calendar-manager-0.16.0-source.zip`;
- plik `SHA256SUMS.txt`.
