...
ENGLISH_TRANSLATIONS: dict[str, str] = {
    ...
    "Język aplikacji zostanie zmieniony na {language} po ponownym uruchomieniu.": "The application language will change to {language} after restart.",
    ...
    "GCM by Piotrek 0.11.0 — język polski i angielski": "GCM by Piotrek 0.11.0 — Polish and English",
