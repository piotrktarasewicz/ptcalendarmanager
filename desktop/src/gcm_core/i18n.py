...
ENGLISH_TRANSLATIONS: dict[str, str] = {
    ...
    "Język aplikacji zostanie zmieniony. Aby zastosować nowe ustawienie, PT Calendar Manager musi zostać uruchomiony ponownie.\n\nWybierz „Uruchom ponownie teraz”, aby zamknąć i ponownie uruchomić aplikację, albo „Później”, aby zastosować zmianę przy następnym uruchomieniu.": "The application language has been changed. PT Calendar Manager must be restarted to apply the new setting.\n\nChoose ‘Restart now’ to close and restart the application, or ‘Later’ to apply the change the next time PT Calendar Manager starts.",
    "Ponowne uruchomienie PT Calendar Manager": "Restart PT Calendar Manager",
    "Uruchom ponownie teraz": "Restart now",
    "Zamyka bieżącą instancję i uruchamia PT Calendar Manager ponownie w wybranym języku.": "Closes the current instance and restarts PT Calendar Manager in the selected language.",
    "Później": "Later",
    "Pozostawia aplikację otwartą. Nowy język zostanie zastosowany przy następnym uruchomieniu.": "Keeps the application open. The new language will be applied the next time PT Calendar Manager starts.",
    "Zmiana języka zostanie zastosowana przy następnym uruchomieniu.": "The language change will be applied the next time PT Calendar Manager starts.",
    "Nie udało się ponownie uruchomić aplikacji. Ustawienie języka zostało zapisane i będzie użyte przy następnym ręcznym uruchomieniu.\n\n{error}": "PT Calendar Manager could not be restarted. The language setting has been saved and will be used the next time you start the application manually.\n\n{error}",
    ...
    "Systemowa lista kalendarzy nie obsługuje pól wyboru.": "The system calendar list does not support check boxes.",
    ...
    "PT Calendar Manager 0.11.2 — poprawione pierwsze uruchomienie i obsługa Google": "PT Calendar Manager 0.11.2 — improved first launch and Google handling",
    "PT Calendar Manager 0.12.0 — stabilizacja dostępnego interfejsu": "PT Calendar Manager 0.12.0 — accessible interface stabilization",
    "PT Calendar Manager 0.13.0": "PT Calendar Manager 0.13.0",
    "Główne okno PT Calendar Manager": "PT Calendar Manager main window",
    ...
    "Skopiowano dane z wcześniejszej nazwy aplikacji: {items}": "Copied data from the earlier application name: {items}",
    ...
    "Brak aktywnego logowania Google. Użyj polecenia Zaloguj do Google w menu Konto.": "No active Google sign-in. Use Sign in to Google in the Account menu.",
    ...
    "Błąd PT Calendar Manager": "PT Calendar Manager error",
    ...
    "Czy wylogować aplikację PT Calendar Manager? Token dodatku NVDA nie zostanie zmieniony.": "Sign PT Calendar Manager out? The NVDA add-on token will not be changed.",
    ...
    "Na tym komputerze nie znaleziono konfiguracji logowania Google client_secret.json. Jest ona potrzebna do rozpoczęcia logowania.\n\nSkopiuj ten plik z poprzedniego komputera z katalogu %APPDATA%\\PT Calendar Manager albo wskaż plik używany przez wtyczkę NVDA. Po wybraniu OK otworzy się okno wyboru pliku.": "The Google sign-in configuration file client_secret.json was not found on this computer. It is required to start signing in.\n\nCopy the file from %APPDATA%\\PT Calendar Manager on the previous computer, or select the file used by the NVDA add-on. After choosing OK, a file selection dialog will open.",
    ...
    "zaawansowany cykl utworzony poza PT Calendar Manager": "advanced recurrence created outside PT Calendar Manager",
    ...
    "Ten cykl ma zaawansowaną regułę powtarzania. PT Calendar Manager może edytować pojedyncze wystąpienie, ale cały cykl trzeba zmienić w oficjalnym Kalendarzu Google.": "This series has an advanced recurrence rule. PT Calendar Manager can edit one occurrence, but the entire series must be changed in the official Google Calendar interface.",
    "Ten cykl ma zaawansowaną regułę powtarzania i nie może być bezpiecznie uproszczony przez PT Calendar Manager.": "This series has an advanced recurrence rule and cannot be safely simplified by PT Calendar Manager.",
    ...
    "To jest specjalny typ wydarzenia: {kind}. PT Calendar Manager edytuje obecnie zwykłe wydarzenia kalendarza.": "This is a special event type: {kind}. PT Calendar Manager currently edits standard calendar events.",
    ...
    "Czy na pewno wykonać tę operację?\n\n{details}\n\n{notices}\n\nTej operacji nie można cofnąć w aplikacji PT Calendar Manager.": "Are you sure you want to perform this operation?\n\n{details}\n\n{notices}\n\nThis operation cannot be undone in PT Calendar Manager.",
    ...
    "Ten rodzaj wydarzenia nie jest jeszcze obsługiwany przez edycję PT Calendar Manager.": "This event type is not currently supported by PT Calendar Manager editing.",
